...
class StarsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final meteorsWidget = meteors(); // değişken 1
    final topTitleAndImageWidget = topTitleAndImage(context); // değişken 2
    final starsScrollWidget = starsScroll(); // değişken 3
    return Scaffold(
      backgroundColor: SpaceColors.backgroundColor,
      body: Stack(
        alignment: Alignment.center,
        children: [
          meteorsWidget, // build 1
          Column(
            children: [
              topTitleAndImageWidget, // build 2
              starsScrollWidget, // build 3
            ],
          ),
        ],
      ),
  ...
  SizedBox starsScroll() {
    return SizedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: List.generate(starContainers.length, (index) {
            return Padding(
